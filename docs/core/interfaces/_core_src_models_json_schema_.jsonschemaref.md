[@aujsf/core](../README.md) › [Globals](../globals.md) › ["core/src/models/json-schema"](../modules/_core_src_models_json_schema_.md) › [JsonSchemaRef](_core_src_models_json_schema_.jsonschemaref.md)
...
*Defined in [core/src/models/json-schema.ts:105](https://github.com/jbockle/au-jsonschema-form/blob/master/packages/core/src/models/json-schema.ts#L105)*
