[@aujsf/core](../README.md) › ["core/src/models/json-schema"](../modules/_core_src_models_json_schema_.md) › [JsonSchemaString](_core_src_models_json_schema_.jsonschemastring.md)
