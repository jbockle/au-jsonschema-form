[@aujsf/core](../README.md) › [Globals](../globals.md) › ["core/src/models/json-schema"](../modules/_core_src_models_json_schema_.md) › [JsonSchemaBoolean](_core_src_models_json_schema_.jsonschemaboolean.md)
