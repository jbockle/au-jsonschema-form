[@aujsf/core](../README.md) › [Globals](../globals.md) › ["core/src/models/json-schema"](../modules/_core_src_models_json_schema_.md) › [JsonSchemaAllOf](_core_src_models_json_schema_.jsonschemaallof.md)
...
*Defined in [core/src/models/json-schema.ts:109](https://github.com/jbockle/au-jsonschema-form/blob/edb7bd4/packages/core/src/models/json-schema.ts#L109)*
