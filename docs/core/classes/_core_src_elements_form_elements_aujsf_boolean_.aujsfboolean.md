...
*Defined in [core/src/elements/form-elements/aujsf-boolean.ts:13](https://github.com/jbockle/au-jsonschema-form/blob/ffdfbe8/packages/core/src/elements/form-elements/aujsf-boolean.ts#L13)*
