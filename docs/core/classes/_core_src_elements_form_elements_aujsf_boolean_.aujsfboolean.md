[@aujsf/core](../README.md) › ["core/src/elements/form-elements/aujsf-boolean"](../modules/_core_src_elements_form_elements_aujsf_boolean_.md) › [AujsfBoolean](_core_src_elements_form_elements_aujsf_boolean_.aujsfboolean.md)
...
* [viewStrategy](_core_src_elements_form_elements_aujsf_boolean_.aujsfboolean.md#viewstrategy)
...
* [createViewStrategy](_core_src_elements_form_elements_aujsf_boolean_.aujsfboolean.md#protected-createviewstrategy)
* [dispatchEvent](_core_src_elements_form_elements_aujsf_boolean_.aujsfboolean.md#protected-dispatchevent)
* [getTemplate](_core_src_elements_form_elements_aujsf_boolean_.aujsfboolean.md#protected-gettemplate)
...
\+ **new AujsfBoolean**(`_element`: Element, `_templateRegistry`: [FormTemplateRegistry](_core_src_services_form_template_registry_.formtemplateregistry.md), `context`: [FormContext](_core_src_services_form_context_.formcontext.md)): *[AujsfBoolean](_core_src_elements_form_elements_aujsf_boolean_.aujsfboolean.md)*
...
*Defined in [core/src/elements/form-elements/aujsf-boolean.ts:9](https://github.com/jbockle/au-jsonschema-form/blob/05b11cf/packages/core/src/elements/form-elements/aujsf-boolean.ts#L9)*
...
*Defined in [core/src/elements/form-elements/aujsf-boolean.ts:11](https://github.com/jbockle/au-jsonschema-form/blob/05b11cf/packages/core/src/elements/form-elements/aujsf-boolean.ts#L11)*
