...
*Defined in [core/src/elements/form-elements/aujsf-number.ts:15](https://github.com/jbockle/au-jsonschema-form/blob/edb7bd4/packages/core/src/elements/form-elements/aujsf-number.ts#L15)*
