[@aujsf/core](../README.md) › ["core/src/elements/form-elements/aujsf-number"](../modules/_core_src_elements_form_elements_aujsf_number_.md) › [AujsfNumber](_core_src_elements_form_elements_aujsf_number_.aujsfnumber.md)
...
* [viewStrategy](_core_src_elements_form_elements_aujsf_number_.aujsfnumber.md#viewstrategy)
...
* [bound](_core_src_elements_form_elements_aujsf_number_.aujsfnumber.md#protected-bound)
* [createViewStrategy](_core_src_elements_form_elements_aujsf_number_.aujsfnumber.md#protected-createviewstrategy)
* [dispatchEvent](_core_src_elements_form_elements_aujsf_number_.aujsfnumber.md#protected-dispatchevent)
* [getTemplate](_core_src_elements_form_elements_aujsf_number_.aujsfnumber.md#protected-gettemplate)
...
\+ **new AujsfNumber**(`_element`: Element, `_templateRegistry`: [FormTemplateRegistry](_core_src_services_form_template_registry_.formtemplateregistry.md), `context`: [FormContext](_core_src_services_form_context_.formcontext.md)): *[AujsfNumber](_core_src_elements_form_elements_aujsf_number_.aujsfnumber.md)*
...
*Defined in [core/src/elements/form-elements/aujsf-number.ts:9](https://github.com/jbockle/au-jsonschema-form/blob/05b11cf/packages/core/src/elements/form-elements/aujsf-number.ts#L9)*
...
*Defined in [core/src/elements/form-elements/aujsf-number.ts:11](https://github.com/jbockle/au-jsonschema-form/blob/05b11cf/packages/core/src/elements/form-elements/aujsf-number.ts#L11)*
