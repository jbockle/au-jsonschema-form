[@aujsf/core](../README.md) › [Globals](../globals.md) › ["core/src/elements/form-elements/aujsf-string"](../modules/_core_src_elements_form_elements_aujsf_string_.md) › [AujsfString](_core_src_elements_form_elements_aujsf_string_.aujsfstring.md)
...
* [_container](_core_src_elements_form_elements_aujsf_string_.aujsfstring.md#protected-_container)
...
* [engine](_core_src_elements_form_elements_aujsf_string_.aujsfstring.md#protected-optional-engine)
...
* [signaler](_core_src_elements_form_elements_aujsf_string_.aujsfstring.md#protected-optional-signaler)
...
* [view](_core_src_elements_form_elements_aujsf_string_.aujsfstring.md#optional-view)
* [viewProvider](_core_src_elements_form_elements_aujsf_string_.aujsfstring.md#protected-viewprovider)
...
* [detached](_core_src_elements_form_elements_aujsf_string_.aujsfstring.md#detached)
* [dispatchEvent](_core_src_elements_form_elements_aujsf_string_.aujsfstring.md#protected-dispatchevent)
* [enhance](_core_src_elements_form_elements_aujsf_string_.aujsfstring.md#protected-enhance)
...
* [resolveUISchemaDefaults](_core_src_elements_form_elements_aujsf_string_.aujsfstring.md#protected-resolveuischemadefaults)
* [schemaChanged](_core_src_elements_form_elements_aujsf_string_.aujsfstring.md#schemachanged)
* [unbind](_core_src_elements_form_elements_aujsf_string_.aujsfstring.md#unbind)
...
\+ **new AujsfString**(`_element`: Element, `_container`: Container, `_templateRegistry`: [FormTemplateRegistry](_core_src_services_form_template_registry_.formtemplateregistry.md), `context`: [FormContext](_core_src_services_form_context_.formcontext.md), `viewProvider`: [ViewProvider](_core_src_services_providers_view_provider_.viewprovider.md)‹[JsonSchema](../modules/_core_src_models_json_schema_.md#jsonschema)›, `signaler?`: BindingSignaler, `engine?`: BindingEngine): *[AujsfString](_core_src_elements_form_elements_aujsf_string_.aujsfstring.md)*
...
*Defined in [core/src/elements/form-elements/aujsf-string.ts:12](https://github.com/jbockle/au-jsonschema-form/blob/edb7bd4/packages/core/src/elements/form-elements/aujsf-string.ts#L12)*
